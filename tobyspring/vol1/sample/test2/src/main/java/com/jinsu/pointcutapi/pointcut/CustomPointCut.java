package com.jinsu.pointcutapi.pointcut;
...
import com.jinsu.pointcutapi.service.CustomAnnotation;

public class CustomPointCut implements Pointcut {

	@Override
	public ClassFilter getClassFilter() {
				return clazz -> clazz.getName().startsWith("com.jinsu.pointcutapi.service");
	}
